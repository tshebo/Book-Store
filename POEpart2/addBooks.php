<?php
/*this is the page that adds the books in the table
 the admin can choose to add books of their own, verify book seller requests, delete books
 the admin should manage the communication between buyers and sellers*/
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO tblbooks (title, author, ISBN, genre, bookCondition, price, cover, description)
VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
